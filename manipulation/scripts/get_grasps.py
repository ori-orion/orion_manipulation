...
def callback(msg):
    ...
    if len(grasps) > 0:
        ...
        approach_4 = np.array([grasp.approach.x, grasp.approach.y, grasp.approach.z , 0])
        binormal_4 = np.array([grasp.binormal.x, grasp.binormal.y, grasp.binormal.z, 0])
        axis_4 = np.array([grasp.axis.x, grasp.axis.y, grasp.axis.z, 0])
        ...
        print 'Approach:', approach_4
        print 'Binormal:', binormal_4
        print 'Axis:', axis_4
